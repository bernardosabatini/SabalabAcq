...
function varargout = selectButton_Callback(h, eventdata, handles, varargin)
	...
	startColumnForFrameData = round((lineDelayFraction*state.internal.samplesPerLine));	
	fractionStart=startColumnForFrameData/state.internal.samplesPerLine;
	fractionEnd=(state.acq.samplesUsedPerLine+startColumnForFrameData)/state.internal.samplesPerLine;
